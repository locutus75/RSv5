...
export async function sendViaSMTP({ tenant, parsed, rcpts, envelopeFrom, smtpServer, localAddress }) {
  ...
  const transporterConfig = {
    ...
    // Gebruik lokaal IP adres voor uitgaande verbinding als opgegeven (niet 0.0.0.0)
    localAddress: localAddress && localAddress !== "0.0.0.0" ? localAddress : undefined
  };
  
  if (localAddress && localAddress !== "0.0.0.0") {
    console.log(`   Uitgaand IP adres: ${localAddress}`);
  }
