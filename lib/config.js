...
export async function loadConfig() {
  try {
    ...
    console.log(`🔍 Configuratie structuur:`);
    console.log(`   cfg heeft 'service' property: ${!!cfg.service}`);
    console.log(`   cfg.service.serverIP: ${cfg.service?.serverIP || 'NIET AANWEZIG'}`);
    console.log(`   Volledige cfg: ${JSON.stringify(cfg, null, 2)}`);
    ...
    console.log(`🔍 Service configuratie details:`);
    console.log(`   serverIP: ${cfg.service?.serverIP || 'NIET AANWEZIG'}`);
    console.log(`   listenPort: ${cfg.service?.listenPort || 'niet ingesteld'}`);
